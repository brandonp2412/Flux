...
mod tests {
    ...
    fn ui_hover_uses_contracts_even_when_builtin_view_source_is_incomplete() {
        ...
        assert!(element.contains(
            "element Text { text: str, selectable: bool, size: i64, bold: bool, color: str, visible: bool, tooltip: str, accessibility_label: str, accessibility_description: str, min_width: i64, min_height: i64 }"
        ));
