pub fn qualified<'a>(namespace: &str, name: &'a str) -> &'a str {
    match (namespace, name) {
        ...
        ("http", "receiveRequestWithTextBodyTrailers") => "readRequestBodyTrailers",
        ("http", "receiveRequestWithBinaryBody") => "readRequestBytes",
        ("http", "receiveRequestWithBinaryBodyTrailers") => "readRequestBytesTrailers",
        ("http", "receiveResponseHeadWithHeaders") => "readResponse",
        ("http", "receiveResponseWithTextBody") => "readResponseBody",
        ("http", "receiveResponseWithTextBodyTrailers") => "readResponseBodyTrailers",
        ("http", "receiveResponseWithBinaryBody") => "readResponseBytes",
        ("http", "receiveResponseWithBinaryBodyTrailers") => "readResponseBytesTrailers",
...
pub fn qualified_impl<'a>(namespace: &str, name: &'a str) -> &'a str {
    match (namespace, name) {
        ...
        ("http", "readRequestBodyTrailers") => "receiveRequestWithTextBodyTrailers",
        ("http", "readRequestBytes") => "receiveRequestWithBinaryBody",
        ("http", "readRequestBytesTrailers") => "receiveRequestWithBinaryBodyTrailers",
        ("http", "readResponse") => "receiveResponseHeadWithHeaders",
        ("http", "readResponseBody") => "receiveResponseWithTextBody",
        ("http", "readResponseBodyTrailers") => "receiveResponseWithTextBodyTrailers",
        ("http", "readResponseBytes") => "receiveResponseWithBinaryBody",
        ("http", "readResponseBytesTrailers") => "receiveResponseWithBinaryBodyTrailers",
