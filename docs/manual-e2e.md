...
- application title, default width/height, resizability, theme mode, layout direction, and root-grid gap/padding changes are included in that in-process Linux hot-apply path;
